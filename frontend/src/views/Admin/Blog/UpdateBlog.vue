    ...
    <div class="add-container">
        <div class="back-container">
            <router-link to="/adminBlogs">
                <button class="btn">
                    <svg xmlns="http://www.w3.org/2000/svg" class="svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#3e96f3">
        ...
        <div v-if="isLoadingUpdate" class="loading-form">
            <LoaderComponentBlue />
        </div>
        <form v-else @submit.prevent="submitForm">
            ...
            <div class="wrapper-fields">
                ...
                <div v-if="currentImageUrl && !previewImage" class="current-image-container">
                    <h4>Current Image:</h4>
                    <img :src="currentImageUrl" alt="Current blog image" class="current-image" />
                    <p class="image-note">Upload a new image to replace the current one</p>
                </div>
                    ...
                    <div class="upload-area" 
                        ...
                        <div v-if="!previewImage" class="upload-prompt">
                            <div class="upload-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#3e96f3">
                            ...
                            <h3 class="upload-title">
                                {{ isDragActive ? 'Drop image here' : (currentImageUrl ? 'Upload New Photo' : 'Upload Photo') }}
                            </h3>
            ...
            <div class="wrapper-fields">
                ...
                <div class="btn-container">
                    <button type="button" @click="addSubtopic">Add Subtopic</button>
                </div>
            </div>
            ...
            <div v-else class="btn-wrapper">
                <span>Updating Blog... Please wait.</span>
...
export default {
    name: "updateBlog",
    components: { LoaderComponent, ToastNotification, LoaderComponentBlue, QuillEditor },
    data() {
        return {
            isDragActive: false,
            previewImage: null,
            ...
            blogPost: {
                ...
                reading_time: "",
                description: "",
                image: null, // Will store the new file if uploaded
            },
            categoriesList: [],
            isLoading: false,
    ...
    methods: {
        submitForm() {
            ...
            formData.append("_id", this.blogPost._id);
            ...
            axios
                .put(`${BASE_URL}/articles/update/${this.blogPost._id}`, formData, {
                    withCredentials: true,
                })
                .then(() => {
                    this.$router.push("/adminBlogs");
                ...
                .catch((error) => {
                    ...
                    this.message = "An error occurred while updating the blog.";
                    this.bgc = "error";
                    this.isVisible = true;
                })
        ...
        fetchBlogPostDetails() {
            ...
            axios
                .get(`${BASE_URL}/articles/data/${blogId}`, {
                    withCredentials: true,
                })
                .then((response) => {
                    const blog = response.data;

                    // Set the blogPost object with fetched data
                    this.blogPost = {
                        _id: blog._id,
                        title: blog.title,
                        text: blog.text,
                        ...
                        image: null, // Don't set the image file here
                        category: blog.category._id,
                    };

                    // Store the current image URL separately
                    if (blog.image) {
                        this.currentImageUrl = this.getImgUrl(blog.image);
                    }
        ...
        // Utility method to convert image data to displayable URL
